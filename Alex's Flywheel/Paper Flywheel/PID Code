...
#pragma config(Motor,  port6,           flyWheelL1,    tmotorVex393_MC29, openLoop, reversed, encoderPort)
#pragma config(Motor,  port7,           FlyWheelL2,    tmotorVex393_MC29, openLoop, I2C_1)
#pragma config(Motor,  port8,           flyWheelR1,    tmotorVex393_MC29, openLoop)
...
{
		startTask(flashLED);
	pidInit(flyWheelL, 33, 45, 60, 0, 50);
	pidInit(flyWheelR, 33, 45, 60, 0, 50);
	...
	while (true)
	{
		...
		rpmAvgL = abs(rpmL + lastRpmL1 + lastRpmL2 + lastRpmL3 + lastRpmL4)/5;
		rpmAvgR = abs(rpmR + lastRpmR1 + lastRpmR2 + lastRpmR3 + lastRpmR4)/5;
