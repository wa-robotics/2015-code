...
#pragma config(Motor,  port1,           RBdrive,       tmotorVex393_HBridge, openLoop, reversed)
#pragma config(Motor,  port2,           RFdrive,       tmotorVex393_MC29, openLoop, reversed)
...
#pragma config(Motor,  port9,           LFdrive,       tmotorVex393_MC29, openLoop)
