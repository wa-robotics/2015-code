...
#pragma config(Motor,  port2,           RFfly,         tmotorVex393_MC29, openLoop, reversed, encoderPort, I2C_1)
#pragma config(Motor,  port3,           LBfly,         tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port4,           RBfly,         tmotorVex393_MC29, openLoop)
...
task main()
{
  while(1 == 1)
  {
  /*int preventionValue = 0;
  if (preventionValue == 0)
  {
