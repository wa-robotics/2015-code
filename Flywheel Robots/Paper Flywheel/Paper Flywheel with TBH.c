...
void initializeTBH() {
	tbhInit(lFly, 627.2, 0.00020); //initialize TBH for left side of the flywheel
	tbhInit(rFly, 627.2, 0.00020); //initialize TBH for the right side of the flywheel
...
task usercontrol()
{
	bLCDBacklight = true;
	initializeTBH();
	FwVelocitySet(lFly, 77, normalizeMotorPower(78));
	FwVelocitySet(rFly, 77, normalizeMotorPower(78));
