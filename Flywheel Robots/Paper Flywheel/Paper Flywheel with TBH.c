...
#pragma config(Motor,  port2,           flyWheelL2,    tmotorVex393_MC29, openLoop, reversed, encoderPort, I2C_1)
#pragma config(Motor,  port4,           flyWheelR1,    tmotorVex393_MC29, openLoop, reversed, encoderPort, None)
#pragma config(Motor,  port5,           flyWheelR2,    tmotorVex393_MC29, openLoop, encoderPort, I2C_2)
...
void initializeTBH() {
	tbhInit(lFly, 627.2, 0.005); //initialize TBH for left side of the flywheel
	tbhInit(rFly, 627.2, 0.005); //initialize TBH for the right side of the flywheel
