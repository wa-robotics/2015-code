#pragma config(Motor,  port1,           lDriveFront,   tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port2,           lDriveBack,    tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port10,           rDriveFront,   tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port9,           rDriveBack,    tmotorVex393_MC29, openLoop, reversed)
