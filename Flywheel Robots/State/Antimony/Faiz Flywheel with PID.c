...
#pragma config(Motor,  port1,           intakeRoller,  tmotorVex393HighSpeed_HBridge, openLoop, encoderPort, I2C_3)
...
#pragma config(Motor,  port10,          intakeChain,   tmotorVex393HighSpeed_HBridge, openLoop, encoderPort, I2C_4)
