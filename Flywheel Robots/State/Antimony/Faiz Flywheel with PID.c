...
#pragma config(Motor,  port1,           intakeLeft,    tmotorVex393TurboSpeed_HBridge, openLoop, reversed)
...
#pragma config(Motor,  port10,          intakeRight,   tmotorVex393TurboSpeed_HBridge, openLoop, encoderPort, I2C_3)
