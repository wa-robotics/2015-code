...
void initializePIDLong() {
	...
	tbhInit(lFly, 392, 0.2481, 0.7481, 0.005481, 0, 75, 20); //initialize PID for left side of the flywheel //left side might be able to have a higher P
	tbhInit(rFly, 392, 0.2481, 0.7481, 0.005481, 0, 75, 20); //initialize PID for right side of the flywheel //x.x481
