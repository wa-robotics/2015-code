...
#pragma config(Motor,  port1,           rDriveFront,   tmotorVex393TurboSpeed_HBridge, openLoop, reversed, encoderPort, I2C_4)
...
#pragma config(Motor,  port4,           intakeRoller,  tmotorVex393TurboSpeed_MC29, openLoop, reversed, encoderPort, I2C_3)
#pragma config(Motor,  port5,           intakeChain,   tmotorVex393TurboSpeed_MC29, openLoop, reversed)
...
//			setIntakeMotors(125);
	...
	motor[intakeChain] = 128;
	motor[intakeRoller] = 128;
	flywheelWorking = 1;
