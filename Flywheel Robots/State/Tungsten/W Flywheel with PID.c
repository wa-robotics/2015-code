...
#pragma config(Motor,  port1,           intakeRoller,  tmotorVex393TurboSpeed_MC29, openLoop, encoderPort, I2C_3)
...
#pragma config(Motor,  port4,           rDriveFront,   tmotorVex393TurboSpeed_HBridge, openLoop, reversed, encoderPort, I2C_4)
