...
#pragma config(Motor,  port1,           bottomIntake,  tmotorVex393HighSpeed_HBridge, openLoop)
...
#pragma config(Motor,  port9,           rFlywheel,     tmotorVex393HighSpeed_MC29, openLoop, encoderPort, I2C_1)
