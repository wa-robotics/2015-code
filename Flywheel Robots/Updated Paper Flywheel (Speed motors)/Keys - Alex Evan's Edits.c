...
void initializeTBHClose() {
	tbhInit(lFly, 392, 0.000300);//.0002 //initialize TBH for left side of the flywheel
	tbhInit(rFly, 392, 0.000300); //.000275 //initialize TBH for right side of the flywheel
	//motor[intake] = 127;
	//start the flywheel control tasks
	startTask(leftFwControlTask);
	startTask(rightFwControlTask);
