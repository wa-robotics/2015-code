...
#pragma config(Motor,  port2,           Fly6,          tmotorVex393HighSpeed_MC29, openLoop, reversed)
#pragma config(Motor,  port3,           Fly5,          tmotorVex393HighSpeed_MC29, openLoop, encoderPort, I2C_1)
...
#pragma config(Motor,  port8,           Fly1,          tmotorVex393HighSpeed_MC29, openLoop)
...
task flywheelController() { //manages flywheel starts and stops
	while(1) {
		...
		if(vexRT[Btn7U] == 1 || codeTestingOverride == 1){ //full field
			...
			L_GAIN = 0.000550; //test this change first
			R_GAIN = 0.000550;
			leftFwVelocitySet(135, .669);
			rightFwVelocitySet(135, .669);
