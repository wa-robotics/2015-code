...
#pragma config(Motor,  port1,           intakeLong,    tmotorVex393HighSpeed_HBridge, openLoop)
...
#pragma config(Motor,  port9,           flyWheelR2,    tmotorVex393HighSpeed_MC29, openLoop, reversed, encoderPort, I2C_2)
