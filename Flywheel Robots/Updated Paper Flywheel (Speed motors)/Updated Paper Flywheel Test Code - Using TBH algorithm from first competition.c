...
#pragma config(Motor,  port2,           Fly6,          tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port3,           Fly5,          tmotorVex393_MC29, openLoop, reversed, encoderPort, I2C_1)
...
#pragma config(Motor,  port8,           Fly1,          tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port9,           Fly2,          tmotorVex393_MC29, openLoop, encoderPort, I2C_2)
...
task flywheelController() { //manages flywheel starts and stops
	while(1)
	{
		...
		if(/*vexRT[Btn5D] == 1 &&*/ !flywheelRunning){
			...
			motor[intake1] = -125;
			motor[intake2] = -125;
			leftFwVelocitySet(138,0.59);//was 100
			rightFwVelocitySet(138,0.59);//was 100
