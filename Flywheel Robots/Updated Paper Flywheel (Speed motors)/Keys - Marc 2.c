...
void initializeTBH() {
	tbhInit(lFly, 392, 0.000275);//.0002 //initialize TBH for left side of the flywheel
	tbhInit(rFly, 392, 0.000275); //.000275 //initialize TBH for right side of the flywheel
	//motor[intake] = 127;
