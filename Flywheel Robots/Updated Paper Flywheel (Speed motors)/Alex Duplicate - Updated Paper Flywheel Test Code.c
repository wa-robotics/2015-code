...
#pragma config(Sensor, dgtl12, yellowLED,      sensorLEDtoVCC)
...
#pragma config(Motor,  port3,           rFlyTop,       tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port4,           lFlyTop,       tmotorVex393HighSpeed_MC29, openLoop)
...
#pragma config(Motor,  port7,           lFlyBottom,    tmotorVex393HighSpeed_MC29, openLoop, reversed, encoderPort, I2C_2)
#pragma config(Motor,  port8,           rFlyBottom,    tmotorVex393HighSpeed_MC29, openLoop, reversed, encoderPort, I2C_1)
...
{
	return( -nMotorEncoder[ lFlyBottom ] );
}
...
{
	return( nMotorEncoder[ rFlyBottom ] );
}
