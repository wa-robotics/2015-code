...
#pragma config(Motor,  port3,           flywheelR2,    tmotorVex393HighSpeed_MC29, openLoop, encoderPort, I2C_1)
#pragma config(Motor,  port4,           flywheelL1,    tmotorVex393HighSpeed_MC29, openLoop, reversed)
...
#pragma config(Motor,  port7,           flywheelL2,    tmotorVex393HighSpeed_MC29, openLoop, encoderPort, I2C_2)
#pragma config(Motor,  port8,           flywheelR1,    tmotorVex393HighSpeed_MC29, openLoop, reversed)
...
task usercontrol()
{
 initializeTBH();
	...
	//FwVelocitySet(lFly, 142, normalizeMotorPower(82));
	//FwVelocitySet(rFly, 142, normalizeMotorPower(82));
	//setRFly(rPower)
	//setLFly(lPower);
	//wait1Msec(750);
