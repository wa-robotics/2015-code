...
#pragma config(Motor,  port1,           rDriveFront,   tmotorVex393HighSpeed_HBridge, openLoop)
#pragma config(Motor,  port2,           rDriveBack,    tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port3,           rFlyTop,       tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port4,           rFlyBottom,    tmotorVex393HighSpeed_MC29, openLoop, reversed, encoderPort, I2C_1)
...
#pragma config(Motor,  port7,           lFlyTop,       tmotorVex393HighSpeed_MC29, openLoop, reversed)
#pragma config(Motor,  port8,           lFlyBottom,    tmotorVex393HighSpeed_MC29, openLoop, encoderPort, I2C_2)
#pragma config(Motor,  port9,           LDriveBack,    tmotorVex393HighSpeed_MC29, openLoop, reversed)
#pragma config(Motor,  port10,          LDriveFront,   tmotorVex393HighSpeed_HBridge, openLoop, reversed)
