...
#pragma config(Motor,  port1,           rDriveFront,   tmotorVex393HighSpeed_HBridge, openLoop, reversed)
...
#pragma config(Motor,  port4,           rFlyBottom,    tmotorVex393HighSpeed_MC29, openLoop, reversed, encoderPort, I2C_2)
#pragma config(Motor,  port5,           intakeRoller,  tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port6,           intakeChain,   tmotorVex393HighSpeed_MC29, openLoop, encoderPort, I2C_3)
#pragma config(Motor,  port7,           lFlyTop,       tmotorVex393HighSpeed_MC29, openLoop, reversed, encoderPort, I2C_1)
#pragma config(Motor,  port8,           lFlyBottom,    tmotorVex393HighSpeed_MC29, openLoop)
...
task leftFwControlTask()
{
    ...
    while(1)
        ...
        // Calculate velocity
        getEncoderAndTimeStamp(lFlyTop,fw->e_current, fw->encoder_timestamp);
        FwCalculateSpeed(fw);
