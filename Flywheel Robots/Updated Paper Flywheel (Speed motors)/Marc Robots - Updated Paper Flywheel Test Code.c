...
#pragma config(Motor,  port3,           flyWheelR1,    tmotorVex393HighSpeed_MC29, openLoop)
...
#pragma config(Motor,  port7,           flyWheelL1,    tmotorVex393HighSpeed_MC29, openLoop, reversed)
