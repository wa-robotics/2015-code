...
float positionKp = .345,//.36, //proportional constant for positional PID
			...
			positionKd = 2.125;//4; //derivative constant

static int STRAIGHT = 1.9; //the 2 here shouldn't matter as long as no variables are multiplied by 'direction' in driveDistancePID
...
//}
 ...
 // wait1Msec(2000);
  ...
  driveDistancePID(600, STRAIGHT, 5000); //move forward from tile
  setLDriveMotors(0);
	setRDriveMotors(0);
