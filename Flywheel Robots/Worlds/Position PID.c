...
float positionKp = .345,//.36, //proportional constant for positional PID
			straighteningKpLeft = 0.25,//0.2,//.43,//.195, //proportional constant for straightening response for the left side
			straighteningKpRight = 0.25,//0.2,//.22,//.16, //proportional constant for straightening response for the right side
