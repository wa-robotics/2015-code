...
#pragma config(Motor,  port2,           lFly,          tmotorVex393HighSpeed_MC29, openLoop, encoderPort, I2C_1)
...
#pragma config(Motor,  port9,           rFly,          tmotorVex393HighSpeed_MC29, openLoop, encoderPort, I2C_2)
